...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        {
            var __self = new global::ListPlayerPage(__parent.router);
    ...
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("editPlayer", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::EditPlayerPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "editPlayer";
    }
    ...
    void InitializeUX()
    {
        ...
        var editPlayer = new Template1(this, this);
        router.Name = __selector0;
        temp.Children.Add(temp1);
        temp1.DefaultPath = "home";
        temp1.Templates.Add(home);
        temp1.Templates.Add(editPlayer);
